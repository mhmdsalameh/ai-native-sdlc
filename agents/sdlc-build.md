...
2. **Write the plan.** Name every file touched, the work order, and the tests. For a bug fix, the failing test comes **first** — and the guard blocks editing tests to make them pass.
